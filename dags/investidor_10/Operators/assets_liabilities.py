...
# TODO create more generic class for saving json file. Probably create dag and tasks first and then standardize code based on endpoints format
class AssetsAndLiabilities:
    def __init__(self) -> None:
        self.url = "https://investidor10.com.br/api/balancos/ativospassivos/chart"
        self.url_sufix = "/3650"  # 10 years reading
